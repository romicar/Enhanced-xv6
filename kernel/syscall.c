...
typedef struct systemcalled {
    char systemcalledname[1000];
    int systemcalledargc;
}systemcalled;


systemcalled findinfo[] = 
{
[SYS_fork]    {"fork\0", 0},
[SYS_exit]    {"exit\0", 1},
[SYS_wait]    {"wait\0", 1},
...
[SYS_write]   {"write\0", 3},
[SYS_mknod]   {"mknod\0", 3},
[SYS_unlink]  {"unlink\0", 1},
[SYS_link]    {"link\0", 2},
[SYS_mkdir]   {"mkdir\0", 1},
[SYS_close]   {"close\0", 1},
//************
[SYS_trace]   {"trace\0", 1},
[SYS_set_priority] {"set_priority\0", 2},
[SYS_waitx]   {"waitx\0", 3},
[SYS_settickets] {"settickets\0", 1},
[SYS_sigalarm] {"sigalarm\0", 2},
